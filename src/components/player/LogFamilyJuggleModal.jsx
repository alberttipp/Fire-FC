        ...
        <div className="fixed inset-0 z-[120] flex items-end md:items-center justify-center p-0 md:p-4 bg-black/80 backdrop-blur-sm animate-fade-in" onClick={onClose}>
            ...
            >
                ...
                <div className="flex-1 min-h-0 overflow-y-auto p-6 space-y-4">
                    {/* Who's juggling */}
                    <div>
                        <label className="block text-brand-green text-xs font-bold uppercase tracking-widest mb-1.5">Who's juggling?</label>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder={kind === 'parent' ? 'Dad, Mom, Grandpa…' : 'Mia, little bro…'}
                            maxLength={24}
                    ...
                    {/* Best run */}
                    <div>
                        <label className="block text-brand-green text-xs font-bold uppercase tracking-widest mb-1.5">Best juggles in a row</label>
                        <input
